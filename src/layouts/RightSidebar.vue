        ...
        <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">{{ userDetails.program }}, Class of 2026</p>
                </div>
            </div>
            ...
            <div class="mt-4 flex space-x-2">
                <router-link to="/profile" class="flex-1 bg-indigo-600 text-white text-sm text-center py-1 rounded-md hover:bg-indigo-700"> View Profile  </router-link>
                <router-link
                    to="/settings"
