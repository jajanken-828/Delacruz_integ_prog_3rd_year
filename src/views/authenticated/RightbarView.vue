    ...
    <aside class="hidden xl:flex xl:flex-col xl:w-72 border-l bg-white px-4 py-6 space-y-8">
        ...
        <div class="bg-gray-50 p-4 rounded-lg shadow-sm">
          <div class="flex items-center space-x-3">
            ...
            />
            <div>
              <h4 class="font-semibold text-gray-800">Kenneth Jan Regalado Dela Cruz</h4>
              <p class="text-sm text-gray-500">Bachelor of Science in Information System, Class of 2025-2026</p>
            </div>
          </div>
